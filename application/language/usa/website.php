...
return array(
    ...
    'home_intro_text' => 'The solution your organization needs may be increasing customer loyalty/brand
    development, increasing sales, engaging/retaining employees or decreasing overhead on print material.
    With Gale Press you can bridge the digital gap and offer an engaging mobile App experience. Thanks to
    our software leasing model (MAaaS), you won\'t need a custom app or an internal mobile solutions team.
    Contact us today and use Gale Press to bring the mobile app world to your fingertips.',
