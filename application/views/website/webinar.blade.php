...
<style type="text/css">
    ...
    #info #calendar{
        ...
        height: 139px;
        margin-right: 10px;
        background: url(/website/img/webinar/calendar_03.png) 0 0 no-repeat;
    }
...
<section id="parallax4" style="background-image: url(/website/img/webinar/webinar_background.jpg);" class="parallax">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="blog-preview">
                    <div class="post-info text-center">
                        <a>
                            <img src="/website/img/webinar/fatih_resim.jpg" alt="Mustafa Yerdemir" style="width:99px; height:99px;" class="img-circle user-thumb">
                        </a>
