	...
	<div class="container">
		<div class="row">
			...
			<div class="span6 hidden-phone" >
				...
				<ul class="list icons">
					<li style="list-style-image:url('/website/img/aa.png');">{{__('website.sitemap_whous_detail1')}}</li>
					<li style="list-style-image:url('/website/img/aa.png');">{{__('website.sitemap_whous_detail2')}}</li>
					<li style="list-style-image:url('/website/img/aa.png');">{{__('website.sitemap_whous_detail3')}}</li>
				</ul>
				<p>&nbsp;</p>
			</div>
		</div>
