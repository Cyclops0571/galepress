        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="team-photo"><img src="/website/img/industries/dijital.jpg"
                                ...
                                <div class="team-connection">
                                    <div class="team-connection-list text-center">
                                        <ul>
                                            <li>
                                                <a href="/{{ Session::get('language') }}/{{__('route.website_sectors_digitalpublishing')}}"><img
                                                            src="/website/img/sectors/new/dijital.png"></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-md-4">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="team-photo"><img src="/website/img/industries/egitim.jpg"
                                                         class="img-responsive">
                                <div class="team-connection">
                                    <div class="team-connection-list text-center">
                                        <ul>
                                            <li>
                                                <a href="/{{ Session::get('language') }}/{{__('route.website_sectors_education')}}"><img
                                                            src="/website/img/sectors/new/egitim.png"></a></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-md-4">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="team-photo"><img src="/website/img/industries/perakende.jpg"
                                                         class="img-responsive">
                                <div class="team-connection">
                                    <div class="team-connection-list text-center">
                                        <ul>
                                            <li>
                                                <a href="/{{ Session::get('language') }}/{{__('route.website_sectors_retail')}}"><img
                                                            src="/website/img/sectors/new/perakende.png"></a></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
