...
@section('body-content')
    ...
    <section style="background-image: url(/website/img/sectors/background.jpg);"
            ...
            <div class="row" style="text-align:left;">
                <div class="col-md-5 col-md-offset-1 col-sm-6">
                    ...
                    <div data-wow-delay="1s"
                         class="icon-box icon-lg sep-top-md sep-top-sm icon-gradient wow bounceInRight animated"
                         style="visibility: visible; -webkit-animation-delay: 1s;">
                        <div class="icon-content img-circle transparent"><img src="/website/img/icons/harita.png"/>
                        </div>
                        <div class="icon-box-content">
                ...
                <div class="col-md-6 col-sm-6">
                    <div data-wow-delay="1s"
                         class="icon-box icon-lg sep-top-md sep-top-sm icon-gradient wow bounceInRight animated"
                         style="visibility: visible; -webkit-animation-delay: 1s;">
                        <div class="icon-content img-circle transparent"><img src="/website/img/icons/tooltip.png"/>
                        </div>
                        <div class="icon-box-content">
                    ...
                    <div data-wow-delay="1s"
                         class="icon-box icon-lg sep-top-md sep-top-sm icon-gradient wow bounceInRight animated"
                         style="visibility: visible; -webkit-animation-delay: 1s;">
                        <div class="icon-content img-circle transparent"><img src="/website/img/icons/scroller.png"/>
                        </div>
                        <div class="icon-box-content">
                    ...
                    <div data-wow-delay="1s"
                         class="icon-box icon-lg sep-top-md sep-top-sm icon-gradient wow bounceInRight animated"
                         style="visibility: visible; -webkit-animation-delay: 1s;">
                        <div class="icon-content img-circle transparent"><img src="/website/img/icons/slider.png"/>
                        </div>
                        <div class="icon-box-content">
                    ...
                    <div data-wow-delay="1s"
                         class="icon-box icon-lg sep-top-md sep-top-sm icon-gradient wow bounceInRight animated"
                         style="visibility: visible; -webkit-animation-delay: 1s;">
                        <div class="icon-content img-circle transparent"><img src="/website/img/icons/bookmark.png"/>
                        </div>
                        <div class="icon-box-content">
