...
'&return_url=' . Config::get("custom.iyzico_return_url") . '/payment-response'. //bu ödemenin sonucunu ben hangi sayfaya dönmeliyim. Sitenizde bu ödemeye ait sonuç nereye dönsün. Başarılımı başarısız mı orada anlayacağız.
