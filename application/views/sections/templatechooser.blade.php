...
<div class="site-settings" id="templateChooserBox">
	...
	<div class="content controls reportSubtitle">
		...
		<div class="form-row" style="border-bottom:1px solid black; padding-bottom:10px;">
		    ...
		    <div class="form-row">
			<?php foreach(eTemplateColor::colorSet() as $colorKey => $color): ?>
			<div class="col-md-12">
			    <div class="radiobox-inline">
				<label style="color:<?php echo eTemplateColor::colorCode($colorKey); ?>;">
				    <div class="radio">
					<input type="radio" class="templateForegroundChange" name="templateForeground" value="<?php echo $colorKey; ?>">
				    </div>
				    <?php echo eTemplateColor::colorName($colorKey); ?>
				    <img src="/img/template-chooser/color-picker-blue.png" width="15" style="margin-left:10px;" />
				</label>
			    </div>
			</div>
			<?php endforeach; ?>
