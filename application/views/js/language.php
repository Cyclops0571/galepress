<script type="text/javascript">
	...
	var javascriptLang = <?php echo json_encode(\Laravel\Lang::$lines["application"][Config::get('application.language')]["javascriptlang"]); ?>;
	var interactivity = <?php echo json_encode(\Laravel\Lang::$lines["application"][Config::get('application.language')]["interactivity"]); ?>;
	// -->
</script>
