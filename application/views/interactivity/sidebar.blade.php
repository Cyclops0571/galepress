...
<div class="sidebar">
    <div id="components">
        <div id="tab-container">
            <ul class="etabs">
                <li class="tab"><a href="#tabs-1">{{ __('interactivity.sidebar_tab1') }} <i class="icon-cog"></i></a></li>
                <li class="tab"><a href="#tabs-2">{{ __('interactivity.sidebar_tab2') }} <i class="icon-sitemap"></i></a></li>
            </ul>
