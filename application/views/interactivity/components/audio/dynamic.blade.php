...
<head>
	...
	<script type="text/javascript" src="{{ $baseDirectory }}comp_{{ $id }}/CrbUI/audio/button/js/modernizr.js"></script>
	<script type="text/javascript" src="{{ $baseDirectory }}comp_{{ $id }}/CrbUI/audio/button/js/swfobject.js"></script>
	<script type="text/javascript" src="{{ $baseDirectory }}comp_{{ $id }}/CrbUI/audio/button/js/CrbUI_AudioButton-0.74.adv.js"></script>
	<script type="text/javascript">
		CrbUI_A_CONF['COLOR'] = '#0091ec';
		CrbUI_A_CONF['PATH'] = '{{ $baseDirectory }}comp_{{ $id }}/';
	</script>
	<style type="text/css">
	*{
