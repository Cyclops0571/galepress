...
<body>
	...
	<script type="text/javascript" src="{{ $baseDirectory }}/animation/js/jquery-1.11.1.min.js"></script>
	<script type="text/javascript" src="{{ $baseDirectory }}/animation/js/jquery-ui.min.js"></script>
