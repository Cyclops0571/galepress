  ...
  <div id="wrapper">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top headerPattern" role="navigation">
      ...
      <div class="navbar-header">
        ...
        <h3 style="margin-left:10px;">{{ __('common.orders_appformcreate') }} |<small> <span id="detailStage">{{ __('common.orders_form_addappdetail') }}</span></small></h3>
      </div>

      <!-- Collect the nav links, forms, and other content for toggling -->
      <div class="collapse navbar-collapse navbar-ex1-collapse">
        <ul class="nav navbar-nav side-nav" style="background: #F7F7F7 url('/website/img/sidebarlogo.png') no-repeat center 200px;">
          <li class="active"><a href="#" id="firstListItem" style="line-height: 15px;"><span class="liBordersActive"></span> {{ __('common.orders_app_detail') }}<i class="fa fa-check-circle pull-right" style="opacity:0.3; padding:1px"></i></a></li>
          <li class="disabled"><a href="#" id="secondListItem" style="line-height: 15px;"><span class="liBorders"></span> {{ __('common.orders_app_images') }}<i class="fa fa-check-circle pull-right" style="opacity:0.3; padding:1px"></i></a></li>
          <li class="disabled"><a href="#" id="thirdListItem" style="line-height: 15px;"><span class="liBorders"></span> {{ __('common.orders_app_create') }}<i class="fa fa-check-circle pull-right" style="opacity:0.3; padding:1px"></i></a></li>
      </div><!-- /.navbar-collapse -->
    </nav>
        ...
        <div class="col-lg-6 col-sm-7 col-xs-8">
          <form role="form">
            <div id="stage1">
              ...
              <div class="form-group">
                <label>{{ __('common.orders_name') }} <span style="color: #428bca;font-size: 17px;font-family: monospace;">*</span></label>
                <i style="color: rgba(0,0,0,0.3); font-size:14px; cursor:pointer;" id="AppNamePopup" data-toggle="popover" title="{{ __('common.orders_name') }}" data-content="{{ __('common.orders_hints_appname') }}" class="fa fa-info-circle"></i>
                <input type="text" id="Name" placeholder="{{ __('common.orders_placeholders_appname') }}" name="Name" maxlength="14" class="form-control" required>
              </div>
              ...
              <div class="form-group">
                <label>{{ __('common.orders_keywords') }} <span style="color: #428bca;font-size: 17px;font-family: monospace;">*</span></label>
                <i style="color: rgba(0,0,0,0.3); font-size:14px; cursor:pointer;" id="KeywordsPopup" data-toggle="popover" title="{{ __('common.orders_keywords') }}" data-content="{{ __('common.orders_hints_keywords') }}" class="fa fa-info-circle"></i>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header" style="background: rgb(255, 239, 239);">
            <button type="button" class="close" data-dismiss="modal" id="modal-closeBtn"><span aria-hidden="true">&times;</span><span class="sr-only">{{ __('common.orders_popup_close') }}</span></button>
            <i class="fa fa-exclamation-triangle" style="float: left;font-size: 25px; color: rgb(199, 40, 40);">&nbsp;</i><h4 class="modal-title">{{ __('common.orders_popup_title') }}</h4>
          </div>
          <div class="modal-body">
            <p style="margin:0; font-size:17px;">{{ __('common.orders_popup_content') }}</p>
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-primary" data-dismiss="modal" style="outline:0;">{{ __('common.orders_popup_ok') }}</button>
          </div>
        </div><!-- /.modal-content -->
      </div><!-- /.modal-dialog -->
    </div><!-- /.modal -->
