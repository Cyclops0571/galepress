...
{{ Form::token() }}
<input type="hidden" name="newBanner" value="1"/>
...
<div class="col-md-9">
    <div class="block bg-light-ltr">
        ...
        <div class="col-md-1"><a class="tipr" title="{{ __('common.banners_info_target_content') }}"><span
    ...
    */
    ...
    <div class="form-row">
        ...
        <div class="col-md-8">
            <div class="input-group file">
                <input type="text" id="TargetUrl" class="form-control" name='TargetUrl'
                       value="<?php echo $TargetUrl; ?>" placeholder="<?php echo "http://"; ?>" style="height:35px;"/>
			<span class="input-group-btn">
			    <button class="btn btn-primary urlCheck" type="button" id="checkUrl" onclick="cBanner.checkUrl();"><span
                            class="icon-ok"></span></button>
			</span>
            </div>
            <span class="error urlError hide" style="color:red;">{{__('interactivity.link_error')}}</span>
        </div>
        <div class="col-md-1"><a class="tipr" title="{{ __('common.banners_info_target_address') }}"><span
                        class="icon-info-sign"></span></a></div>
    </div>
    <!--			<div class="form-row">
    ...
    <div class="form-row">
        ...
        <div class="col-md-8">
            <div class="checkbox-inline">
                <div class="checker">
			    <span>
				<input name="BannerActive" type="checkbox"
                       value="1" {{$application->BannerActive ? 'checked="checked"' : '';}} >
			    </span>
                </div>
            </div>
        </div>
        <div class="col-md-1"><a class="tipr" title="{{ __('common.banners_info_banner_active') }}"><span
                        class="icon-info-sign"></span></a></div>
    </div>
    <div class="form-row">
        ...
        <div class="col-md-8">
            <div class="checkbox-inline">
                <div class="checker">
			    <span>
				<input name="BannerAutoplay" type="checkbox"
                       value="1" {{ $application->BannerAutoplay ? 'checked="checked"' : '';}} >
			    </span>
                </div>
            </div>
        </div>
        <div class="col-md-1"><a class="tipr" title="{{ __('common.banners_info_autoplay') }}"><span
                        class="icon-info-sign"></span></a></div>
    </div>
    <div class="form-row">
        <div class="col-md-3">{{__('common.banners_autoplay_interval')}}</div>
        <div class="col-md-8">
            <input type="text" name="BannerIntervalTime" value="{{$application->BannerIntervalTime}}"/>
        </div>
    ...
    <div class="form-row">
        ...
        <div class="col-md-8">
            <input type="text" name="BannerTransitionRate" value="{{$application->BannerTransitionRate; }}"/>
        </div>
    ...
    <div class="form-row">
        ...
        <div class="col-md-1"><a class="tipr" title="{{ __('common.banners_info_active') }}"><span
                        class="icon-info-sign"></span></a></div>
    </div>
    <div class="form-row">
    ...
    <div class="form-row" style="border-top: 1px solid rgb(34, 34, 34);padding-top: 10px;">
        <div class="btn-group col-md-3 col-md-offset-8" style="padding-right:9px;">
            <button type="button" class="btn col-md-7"
                    onclick="javascript:location.href ='{{ URL::to(__('route.banners').'?applicationID='.$ApplicationID) }}'"
                    style="cursor:pointer !important;">{{__('common.map_form_return')}}</button>
            <button type="button" class="btn col-md-5 my-btn-success"
                    onclick="cBanner.save(<?php echo $ApplicationID; ?>);"
                    style="cursor:pointer !important;">{{__('common.detailpage_save')}}</button>
        </div>
    </div>
</div>
