        ...
        <div class="content controls">
            ...
            <div class="form-row">
    			...
    			<span class="input-group-btn">
                    ...
                    <span class="error urlError hide" style="color:#ff0000;">{{__('interactivity.link_error')}}</span>
                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><span class="icon-warning-sign" style="color:#ebaf3c;"></span>&nbsp;Web Link
                    Geçerli Değil!</h4>
            </div>
