			...
			<div class="content controls">
				{{ Form::open(__('route.orders_save'), 'POST') }}
					...
					<div class="form-row">
						...
						<div class="col-md-9">
							<select class="form-control select2"  style="width: 100%;" tabindex="-1" id="ApplicationID" name="ApplicationID">
					...
					<div class="form-row">
						...
						<div class="col-md-9">
							<textarea name="Description" id="Description" class="form-control required" rows="2" cols="20">{{ $Description }}</textarea>
						</div>
					</div>
					<div class="form-row">
						...
						<div class="col-md-9">
							<textarea name="Keywords" id="Keywords" class="form-control required" rows="2" cols="20">{{ $Keywords }}</textarea>
						</div>
					</div>
					<div class="form-row">
						<div class="col-md-3">{{ __('common.orders_product') }}</div>
						<div class="col-md-9">
							<input type="text" name="Product" id="Product" class="form-control textbox" value="{{ $Product }}"/>
						</div>
					</div>
					<div class="form-row">
					...
					<div class="form-row">
						...
						<div class="col-md-9">
							<input type="text" name="Website" id="Website" class="form-control textbox" value="{{ $Website }}"/>
						</div>
					</div>
					<div class="form-row">
					...
					<div class="form-row">
						...
						<div class="col-md-9">
							<input type="text" name="Facebook" id="Facebook" class="form-control textbox" value="{{ $Facebook }}"/>
						</div>
					</div>
					<div class="form-row">
						<div class="col-md-3">{{ __('common.orders_twitter') }}</div>
						<div class="col-md-9">
							<input type="text" name="Twitter" id="Twitter" class="form-control textbox" value="{{ $Twitter }}"/>
						</div>
					</div>
					<?php /*
					<div class="form-row">
					...
					*/ ?>
					<div class="form-row">
						...
						<div class="col-md-9">
							<div class="fileupload_container">
								@if(strlen($Pdf) > 0)
									<a href="/files/orders/order_{{ $OrderNo }}/{{ $Pdf }}" target="_blank" class="uploadedfile">{{ __('common.contents_filelink') }}</a><br />
								@endif
							...
							$(function(){
								...
								if($("html").hasClass("lt-ie10"))
								{
									$("#Pdf").uploadify({
										...
										'fileTypeExts': '*.pdf',
										'buttonText': "{{ __('common.orders_file_select') }}",
										'formData': { 
											'element': 'Pdf',
											'type': 'uploadpdf'
										},
						...
						<div class="col-md-9">
							<div class="fileupload_container">
								@if(strlen($Image1024x1024) > 0)
									<a href="/files/orders/order_{{ $OrderNo }}/{{ $Image1024x1024 }}" target="_blank" class="uploadedfile">{{ __('common.contents_filelink') }}</a><br />
								@endif
								<input type="file" name="Image1024x1024" id="Image1024x1024" class="hidden" />

								<div id="Image1024x1024Button" class="uploadify hide" style="height: 30px; width: 120px; opacity: 1;">
									<div id="File-button" class="uploadify-button " style="height: 30px; line-height: 30px; width: 120px;">
										<span class="uploadify-button-text">{{ __('common.orders_file_select') }}</span>
									</div>
								</div>
							...
							<input type="hidden" name="hdnImage1024x1024Name" id="hdnImage1024x1024Name" value="{{ $Image1024x1024 }}" />
							<script type="text/javascript">
							$(function(){
						...
						<div class="col-md-9">
							<div class="fileupload_container">
								@if(strlen($Image640x960) > 0)
									<a href="/files/orders/order_{{ $OrderNo }}/{{ $Image640x960 }}" target="_blank" class="uploadedfile">{{ __('common.contents_filelink') }}</a><br />
								@endif
						...
						<div class="col-md-9">
							<div class="fileupload_container">
								@if(strlen($Image640x1136) > 0)
									<a href="/files/orders/order_{{ $OrderNo }}/{{ $Image640x1136 }}" target="_blank" class="uploadedfile">{{ __('common.contents_filelink') }}</a><br />
								@endif
								<input type="file" name="Image640x1136" id="Image640x1136" class="hidden" />

								<div id="Image640x1136Button" class="uploadify hide" style="height: 30px; width: 120px; opacity: 1;">
									<div id="File-button" class="uploadify-button " style="height: 30px; line-height: 30px; width: 120px;">
										<span class="uploadify-button-text">{{ __('common.orders_file_select') }}</span>
									</div>
								</div>
							...
							<input type="hidden" name="hdnImage640x1136Name" id="hdnImage640x1136Name" value="{{ $Image640x1136 }}" />
							<script type="text/javascript">
							$(function(){
						...
						<div class="col-md-9">
							<div class="fileupload_container">
								@if(strlen($Image1536x2048) > 0)
									<a href="/files/orders/order_{{ $OrderNo }}/{{ $Image1536x2048 }}" target="_blank" class="uploadedfile">{{ __('common.contents_filelink') }}</a><br />
								@endif
								<input type="file" name="Image1536x2048" id="Image1536x2048" class="hidden" />

								<div id="Image1536x2048Button" class="uploadify hide" style="height: 30px; width: 120px; opacity: 1;">
									<div id="File-button" class="uploadify-button " style="height: 30px; line-height: 30px; width: 120px;">
										<span class="uploadify-button-text">{{ __('common.orders_file_select') }}</span>
									</div>
								</div>
							...
							<input type="hidden" name="hdnImage1536x2048Name" id="hdnImage1536x2048Name" value="{{ $Image1536x2048 }}" />
							<script type="text/javascript">
							$(function(){
						...
						<div class="col-md-9">
							<div class="fileupload_container">
								@if(strlen($Image2048x1536) > 0)
									<a href="/files/orders/order_{{ $OrderNo }}/{{ $Image2048x1536 }}" target="_blank" class="uploadedfile">{{ __('common.contents_filelink') }}</a><br />
								@endif
								<input type="file" name="Image2048x1536" id="Image2048x1536" class="hidden" />

								<div id="Image2048x1536Button" class="uploadify hide" style="height: 30px; width: 120px; opacity: 1;">
									<div id="File-button" class="uploadify-button " style="height: 30px; line-height: 30px; width: 120px;">
										<span class="uploadify-button-text">{{ __('common.orders_file_select') }}</span>
									</div>
								</div>
							...
							<input type="hidden" name="hdnImage2048x1536Name" id="hdnImage2048x1536Name" value="{{ $Image2048x1536 }}" />
							<script type="text/javascript">
							$(function(){
					...
					<div class="form-row">
						...
						@if($OrderID == 0)
							...
							<div class="col-md-2">
								<input type="button" class="btn my-btn-success" name="save" value="{{ __('common.detailpage_save') }}" onclick="cOrder.save();" />
							</div>
						@else
							<div class="col-md-2">
							...
							<div class="col-md-2">
								<input type="button" class="btn my-btn-success" name="save" value="{{ __('common.detailpage_update') }}" onclick="cOrder.save();" />
							</div>
						@endif            
					</div>
				{{ Form::close() }}
	    ...
	    <div class="modal-dialog">
	        <div class="modal-content">
	            ...
	            <div class="modal-footer">
	                <button type="button" class="btn btn-default btn-clean"  data-dismiss="modal" onclick="cOrder.erase();" style="background:#9d0000;">{{ __('common.detailpage_delete') }}</button>       
