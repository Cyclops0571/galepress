            ...
            <div class="content controls" style="overflow:visible">
                ...
                <div class="form-row" style="background: none !important;">
                    ...
                    <div class="col-md-1"><a class="tipr"
                                             title="{{ __('common.contents_tooltip_unpublishdate') }}"><span
                                    class="icon-info-sign"></span></a></div>
                </div>
                <div class="form-row">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            coverImageModalBody.on('resize', function () {
                if ($(this).height() > 200) {
                    dialogCoverImage.show();
                    dialogCoverImage.find('.front').css('transform', 'rotateY(360deg)');
                }
            });

            dialogCoverImage.on('shown.bs.modal', function (e) {

                if (ContentID > 0) {
                    coverImageIframe.attr('iframeContentID', ContentID);
                }
                coverImageIframe.attr('src', '/' + currentLanguage + '/' + route["crop_image"] + "?contentID=" + coverImageIframe.attr('iframeContentID'));
            }).on('hidden.bs.modal', function (e) {
                dialogCoverImage.hide();
                coverImageIframe.attr('src', '');
                dialogCoverImage.find('.front').css('transform', 'rotateY(90deg)');
            });
            if (showCropPage == 'showImageCrop') {
                dialogCoverImage.modal('show');
                coverImageIframe.attr('src', '/' + currentLanguage + '/crop/image?contentID=' + ContentID);
                coverImageIframe.attr("iframeContentID", ContentID);
            }
