...
<div class="col-md-12">    
	...
	<div class="content controls">
	    ...
	    <?php if (count($applications) > 1): ?>
    	    <div class="form-row">
    		<div class="col-md-3"><?php echo __('common.menu_caption_applications'); ?> <span class="error">*</span></div>
    		<div class="col-md-8">
    		...
    		<div class="col-md-1"><a class="tipr" title="<?php echo __('common.menu_caption_applications'); ?>"><span class="icon-info-sign"></span></a></div>
    	    </div>
	    <?php else: ?>
	    ...
	    <div class="form-row">
		<div class="col-md-3"><?php echo __('common.clients_username'); ?> <span class="error">*</span></div>
		<?php echo $errors->first('Username', '<p class="error">:message</p>'); ?>
		<div class="col-md-8">
		    <input type="text" name="Username" id="Username" class="form-control textbox required" value="<?php echo $Username; ?>" autocomplete="off" />
		</div>
		<div class="col-md-1"><a class="tipr" title="<?php echo __('common.clients_username'); ?>"><span class="icon-info-sign"></span></a></div>
	    </div>
	    <div class="form-row">
		...
		<div class="col-md-8">
		    <input type="text" name="Password" id="Password" class="form-control textbox<?php echo $ClientID == 0 ? ' required' : ''; ?>" value="" autocomplete="off" />      
		</div>
		<div class="col-md-1"><a class="tipr" title="<?php echo __('common.clients_password_tooltip'); ?>"><span class="icon-info-sign"></span></a></div>
	    </div>                        
	    <div class="form-row">
		<div class="col-md-3"><?php echo __('common.clients_firstname'); ?> <span class="error">*</span></div>
		...
		<div class="col-md-1"><a class="tipr" title="<?php echo __('common.clients_firstname'); ?>"><span class="icon-info-sign"></span></a></div>
	    </div>
	    <div class="form-row">
		<div class="col-md-3"><?php echo __('common.clients_lastname'); ?> <span class="error">*</span></div>
		...
		<div class="col-md-1"><a class="tipr" title="<?php echo __('common.clients_lastname'); ?>"><span class="icon-info-sign"></span></a></div>
	    </div>
	    <div class="form-row">
		...
		<div class="col-md-1"><a class="tipr" title="<?php echo __('common.users_email'); ?>"><span class="icon-info-sign"></span></a></div>
	    </div>
	    <div class="form-row">
		<div class="col-md-6">
		    <table id="selectedContents" cellpadding="0" cellspacing="0" width="100%" class="table table-bordered table-striped table-hover mySortable">
			<thead>
			    <tr>
				<th>
		...
		<div class="col-md-6 sortableDiv">  
		    <?php if (!empty($selectableContents)): ?>
    		    <table  id="selectableContents" cellpadding="0" cellspacing="0" width="100%" class="table table-bordered table-striped table-hover mySortable">
    			<thead>
    			    <tr>
    				<th>
		...
		<div class="col-md-2">
		    <?php if ($ClientID): ?>
    			...
    			<input type="button" value="<?php echo __('common.detailpage_delete'); ?>" name="delete" class="btn delete expand remove" />
    		    </a>
		    <?php endif; ?>
		</div>
		<div class="col-md-2">
		    <input type="button" class="btn my-btn-success" name="save" value="<?php echo __('common.detailpage_save'); ?>" onclick="cClient.save(<?php echo $ClientID; ?>);" />
		</div>
	    </div>
...
<div class="modal modal-info" id="modal_default_11" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	...
	<div class="modal-content">
		...
		<button type="button" class="btn btn-default btn-clean" data-dismiss="modal" onclick="cClient.erase();" style="background:#9d0000;"><?php echo __('common.detailpage_delete'); ?></button>				
		<button type="button" class="btn btn-default btn-clean" data-dismiss="modal"><?php echo __('common.contents_category_button_giveup'); ?></button>
	    </div>
	</div>
    </div>
</div>
...
<script>
	...
	this.save = function (clientID) {
		...
		fsuccess = function(ret) {
		    ...
		    window.location = '/' + currentLanguage + '/' + route[_self.objectName] + '/' + newObjectID;
		};
	    }
