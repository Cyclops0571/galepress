...
<div class="col-md-12">
	...
	<div class="content controls bg-light-rtl">
		...
		<div class="col-md-5" style="padding-top:5px; float:left;">
			...
			<a href="{{URL::to(__('route.'.$page.'_new'))}}" title="{{__('common.commandbar_add')}}" class="widget-icon widget-icon-circle">
			...
			<a id='FileButton' for='File' href="javascript:void(0)" title="{{__('common.commandbar_excel_upload')}}" class="widget-icon widget-icon-circle"><span class="icon-upload" style="font-size: 15px;"></span></a>
			<script>
			    $("#File").fileupload({
				url: '/client/excelupload',
				dataType: 'json',
	    ...
	    <div class="form-row">
		<div class="col-md-12">  
		    <table id="DataTables_Table_1" cellpadding="0" cellspacing="0" width="100%" class="table table_main table-bordered table-striped table-hover">
			<?php
