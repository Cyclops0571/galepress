/*
 * Custom component control v1.0.0
 *
			...
			if(modalElement.length == 1) {
				...
				if($("html").hasClass("lt-ie10") || $("html").hasClass("lt-ie9") || $("html").hasClass("lt-ie8"))
				{
					...
					$("#prop-" + id + " input[type='file']#comp-" + id + "-modalicon").uploadify({
						...
						'buttonText': interactivity["video_upload_text"],
						'multi': false,
						'formData': { "type": formData },
						'auto': true,
						'onSelect': function (file) {
							$("#prop-" + id + " div.selectfromfile").addClass("hidden");
				...
				if($("html").hasClass("lt-ie10") || $("html").hasClass("lt-ie9") || $("html").hasClass("lt-ie8"))
				{
					...
					$("#prop-" + id + " div.properties input[type='file']#comp-" + id + "-posterimage").uploadify({
						...
						'onSelect': function (file) {
							...
							$('#prop-' + id + ' div.upload-poster div.progress').removeClass("hide");
						},
						'onUploadProgress' : function(file, bytesUploaded, bytesTotal, totalBytesUploaded, totalBytesTotal) {
							var progress = totalBytesUploaded / totalBytesTotal * 100;
							
							$("#prop-" + id + " div.upload-poster div.progress label").html(interactivity["video_uploading"] + ' ' + progress.toFixed(0) + '%');
							$("#prop-" + id + " div.upload-poster div.progress div.scale").css('width', progress.toFixed(0) + '%');
						},
						'onUploadSuccess': function (file, data, response) {
							
							if(data.getValue("success") == "true")
							{
								$("#prop-" + id + " input#comp-" + id + "-posterimagename").val(data.getValue("filename"));
								...
								$("#prop-" + id + " div.properties div.upload-poster a.poster-image")
									.attr("href", "/files/temp/" + data.getValue("filename"))
									.html(data.getValue("filename"))
									.removeClass("hide");
						...
						'onCancel': function(file) {
							$('#prop-' + id + ' div.upload-poster div.progress').addClass("hide");
						}
					});
				}
				else
			...
			else if(componentName == "tooltip")
			{
				...
				if($("html").hasClass("lt-ie10") || $("html").hasClass("lt-ie9") || $("html").hasClass("lt-ie8"))
				{
					...
					$("#prop-" + id + " div.icon1 input[type='file']").uploadify({
						...
						'auto': true,
						'onSelect': function (file) {
							$("#prop-" + id + " div.icon1 div.local").addClass("hide");
							$("#prop-" + id + " div.icon1 div.progress").removeClass("hide");
							$("#prop-" + id + " input#comp-" + id + "-fileselected").val("1");
						...
						'onUploadProgress' : function(file, bytesUploaded, bytesTotal, totalBytesUploaded, totalBytesTotal) {
							...
							$("#prop-" + id + " div.icon1 div.progress label").html(interactivity["video_uploading"] + ' ' + progress.toFixed(0) + '%');
							$("#prop-" + id + " div.icon1 div.progress div.scale").css('width', progress.toFixed(0) + '%');
						},
						'onUploadSuccess': function (file, data, response) {
							...
							if(data.getValue("success") == "true")
							{
								...
								$("#prop-" + id + " div.settings div.properties div.file-header h4").html(data.getValue("filename"));
								$("#prop-" + id + " div.settings div.properties div.file-header span").html((file.size / (1024 * 1024)).toFixed(1) + " MB");
								$("#prop-" + id + " div.icon1 div.progress").addClass("hide");
								$("#prop-" + id + " div.settings div.properties").removeClass("hide");
							}
						},
						'onCancel': function(file) {
				...
				if($("html").hasClass("lt-ie10") || $("html").hasClass("lt-ie9") || $("html").hasClass("lt-ie8"))
				{
					...
					$("#prop-" + id + " div.icon2 input[type='file']").uploadify({
						...
						'buttonText': interactivity["video_upload_text"],
						'multi': false,
						'formData': { "type": formData2 },
						'auto': true,
						'onSelect': function (file) {
							$("#prop-" + id + " div.icon2 div.local").addClass("hide");
							$("#prop-" + id + " div.icon2 div.progress").removeClass("hide");
						...
						'onUploadProgress' : function(file, bytesUploaded, bytesTotal, totalBytesUploaded, totalBytesTotal) {
							...
							$("#prop-" + id + " div.icon2 div.progress label").html(interactivity["video_uploading"] + ' ' + progress.toFixed(0) + '%');
							$("#prop-" + id + " div.icon2 div.progress div.scale").css('width', progress.toFixed(0) + '%');
						},
						'onUploadSuccess': function (file, data, response) {
							...
							if(data.getValue("success") == "true")
							{
								...
								$("#prop-" + id + " input#comp-" + id + "-filename2").val(data.getValue("filename2"));
								$("#prop-" + id + " div.settings div.properties div.file-header h4").html(data.getValue("filename2"));
								$("#prop-" + id + " div.settings div.properties div.file-header span").html((file.size / (1024 * 1024)).toFixed(1) + " MB");
								$("#prop-" + id + " div.icon2 div.progress").addClass("hide");
								$("#prop-" + id + " div.settings div.properties").removeClass("hide");
							}
						},
						'onCancel': function(file) {
