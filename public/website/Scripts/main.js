...
Ottavio.scrollController = function() {
    ...
    if ($mainNavigation.length > 0) {
        ...
        if ($('#contactForm').length > 0 || $('.form-horizontal').length > 0 || $('#blog-frame').length > 0 || $('#tryit').length > 0)
...
$(document).ready(function() {
    ...
    //   function() {
    //     $(this).parent().parent().find('img').before("<img src='/website/img/sectors/shadow.png' class='sectorsImgShadow'>");
    //   }, function() {
