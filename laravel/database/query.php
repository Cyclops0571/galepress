...
/**
 * Class Query
 * @method int count($parameters = null)
 * @method int min($parameters = null)
 * @method int max($parameters = null)
 * @method int avg($parameters = null)
 * @method int sum($parameters = null)
